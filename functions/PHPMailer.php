...
function PHPMailerList($PHPMailer, $arraySessao = array()){
  ...
  for($i = 0; $i < count($arraySessao); $i++){
    ...
    $unidade = $arraySessao[$i]['unidade'];
      ...
      try {
          ...
          $PHPMailer->Body = "Olá diretor(a), Você foi cadastrado(a) no nosso sistema de Gestão Institucional Simplificada(GIS) para administrar a unidade $unidade, aqui estão as suas informações para o seu primeiro login: <br>
