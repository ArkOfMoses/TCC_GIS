          ...
          <form>
            <div class="conta-edit">
              <dl class="grupo-form">
                ...
                <dd>
                  <input type="text" name="nomeUsu" value="Fulano"> <!--value="nome do usuário"-->
              ...
              <dl class="grupo-form">
                ...
                <dd>
                  <input type="text" name="email" value="fulano@gmail.com"> <!--value="email do usuário"-->
              ...
              <dl class="grupo-form">
                ...
                <dd>
                  <input type="text" name="dataNasc" placeholder="00/00/0000">
              ...
              <dl class="grupo-form">
                ...
                <dd>
                  <input type="text" name="CPF" placeholder="000000000/00">
            ...
            <div class="foto-edit">
              ...
              <div class="foto-perfil" style="/*background-image: url(imagens/ilustracao1.png)!important;background-size: cover; background-repeat: no-repeat; background-position: center;">
