...
<html lang="pt-br">
  <head>
      ...
      <!-- Telas Responsivas -->
      <link rel=stylesheet media="screen and (max-width:480px)" href="css/perfilSaude/style480.css">
      <link rel=stylesheet media="screen and (min-width:481px) and (max-width:768px)" href="css/perfilSaude/style768.css">
      <link rel=stylesheet media="screen and (min-width:769px) and (max-width:1024px)" href="css/perfilSaude/style1024.css">
      <link rel=stylesheet media="screen and (min-width:1025px)" href="css/perfilSaude/style1366.css">
      ...
      <div class="content">
        ...
        <header id="on_off">
          ...
          <nav class="menu">
            ...
            <ul>
              <li><a href="#" class="title">Nome da Funcionario</a></li>
