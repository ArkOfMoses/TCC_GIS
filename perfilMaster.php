...
<head>
  ...
  <!-- Telas Responsivas -->
  <link rel=stylesheet media="screen and (max-width:480px)" href="css/perfil/perfil480.css">
  <link rel=stylesheet media="screen and (min-width:481px) and (max-width:768px)" href="css/perfil/perfil768.css">
  <link rel=stylesheet media="screen and (min-width:769px) and (max-width:1024px)" href="css/perfil/perfil1024.css">
  <link rel=stylesheet media="screen and (min-width:1025px)" href="css/perfil/perfil1366.css">
        ...
        <div id="conteudo">
          ...
          <?php
              ...
              for($i = 0; $i < $count; $i++){
                  ...
                  if($codStatusUsuOperacao == 'A'){
                      echo "<a id='botao' href='$linkOperacao' class='bot2$i'>$nomeOperacao</a>";
                  }
              }
            ?>
