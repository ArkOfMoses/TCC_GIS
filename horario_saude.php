...
<html lang="en">
    <head>
        ...
        <!-- Telas Responsivas -->
        <link rel=stylesheet media="screen and (max-width:480px)" href="css/horarioSaude/style480.css">
        <link rel=stylesheet media="screen and (min-width:481px) and (max-width:768px)"
              href="css/horarioSaude/style768.css">
        <link rel=stylesheet media="screen and (min-width:769px) and (max-width:1024px)"
              href="css/horarioSaude/style1024.css">
        <link rel=stylesheet media="screen and (min-width:1025px)" href="css/horarioSaude/style1366.css">
