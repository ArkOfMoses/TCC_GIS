            ...
            if(isset($_REQUEST['codTurma'])){
                if($_REQUEST['codTurma'] != ''){
                    ...
                    if($numDeLinhas == 0){
                        ...
                        <tr>
                            <th colspan='2'>Nome da Disciplina</th>
                        ...
                        while($dedos = $comando->fetch(PDO::FETCH_ASSOC)){
                            ...
                            echo '<tr>';
                            echo "<td colspan='2'>$nomeDisc</td>";
                            echo "<td colspan='2'>$cargHora</td>";
                            echo "<td colspan='1'><a class='botaozin' href='acoes/editarDisc.php?codDisc=$codDisc&codTurma=$codTurma'>Editar</a></td>";
                            echo "<td colspan='2'><a class='botaozin' id='confirma' href='acoes/excluirDisc.php?codDisc=$codDisc&codTurma=$codTurma'>Excluir</a></td>";
                            echo '</tr>';
                        }
                        echo "</table>";
