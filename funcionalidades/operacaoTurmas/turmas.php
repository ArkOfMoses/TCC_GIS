        ...
        <header id="on_off">
          ...
          <nav class="menu">
            ...
            <ul class="menu-buttons">
              ...
              <li><a id="linkmenu" href="funcionalidades/operacaoCursos/cursos.php"><i class="far fa-clock"></i> Cursos</a></li>
              <li><a  id="linkmenu" href="funcionalidades/operacaoDisciplinas/verCursos.php"><i class="far fa-clock"></i> Disciplinas</a></li>
