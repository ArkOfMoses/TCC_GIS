                ...
                <div class="alunos">
                    ...
                    if ($numDeLinhas == 0) {
                        ...
                        while ($dedos = $comando->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            echo " 
                            <div class='endUnid'>
                              <label class='confirma'>Nome da Instituição: </label><p>$nomeInst</p>
                              <label class='confirma'>Razão Social: </label><p>$razaoInst</p>
                              <label class='confirma'>CPNJ da Instituição: </label><p id='cnpj'>$cnpjInst</p>
                            </div>
                              <a class='buttonNext' href='codInstituicao.php?codInst=$codInst'>Editar Informações</a>
