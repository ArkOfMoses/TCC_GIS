...
<html lang="pt-br">
  <head>
      ...
      <!-- CSS PADRÃO -->
      <link href="css/registro/default.css" rel=stylesheet>

      <!-- Telas Responsivas -->
      <link rel=stylesheet media="screen and (max-width:480px)" href="css/registro/style480.css">
      <link rel=stylesheet media="screen and (min-width:481px) and (max-width:768px)" href="css/registro/style768.css">
      <link rel=stylesheet media="screen and (min-width:769px) and (max-width:1024px)" href="css/registro/style1024.css">
      <link rel=stylesheet media="screen and (min-width:1025px)" href="css/registro/style1366.css">
  ...
  <body>
      <div class="content">
        ...
        <footer>
          ...
          <a class="selecionado" >Registro</a>
          <a href="#">Sobre Nós</a>
