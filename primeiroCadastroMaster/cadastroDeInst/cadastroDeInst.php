        ...
        <div class="content">
            ...
            <main>
                <div class="acessoUm">
                    ...
                    <h1>Bem vindo(a)!</h1>
                    <p class="vsf">Este é seu primeiro acesso, agora precisamos 
                    ...
                    <form class='form' method='post' action='cod_cadastroInst.php'>
                        ...
                        <input type="text" name="nomeFant" id="visor">

                        <label>Adicione a razão social da sua intituição:</label>
                        <input type="text" name="razaoSoci" id="visor">
                        
                        <label>Adicione o CNPJ da instituição:</label>
                        <input type="text" name="cnpj" id="visor1">

                        <div class='recebeDados'></div>
                        <div class="puto">
                        <input type="submit" name="Cadastrar" class="buttonNext">
                        </div>                        
