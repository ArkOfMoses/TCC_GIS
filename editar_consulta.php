...
<html lang="pt-br">
  <head>
      ...
      <!-- Telas Responsivas -->
      <link rel=stylesheet media="screen and (max-width:480px)" href="css/TelaSaude/style480.css">
      <link rel=stylesheet media="screen and (min-width:481px) and (max-width:768px)" href="css/TelaSaude/style768.css">
      <link rel=stylesheet media="screen and (min-width:769px) and (max-width:1024px)" href="css/TelaSaude/style1024.css">
      <link rel=stylesheet media="screen and (min-width:1025px)" href="css/TelaSaude/style1366.css">
  ...
  <body>
      <div class="content">
        ...
        <main>
          <!--ISSO É BASICAMENTE PHP (VER TCA DO ANO PASSADO, EH A MESMA COISA)-->
            <div class="header_profile">
                <img src="imagens/avatar_test.jpg" alt="">
                <h2>Nome do profissional</h2>
                <p>Nome da instituição</p>
            </div>
            <div class="add_consulta">
                ...
                <form>
                    ...
                    <div class="partForm">
                        <label>Horário</label>
                        <input type="time" value="07:50">
                    </div>

                    <div class="partForm">
                        <label>Nome do aluno</label>
                        <input type="text" value="Fulanito de la Silvita">
                    </div>
                    ...
                    <div class="partForm">
                        ...
                        <select>
                            <option>Turma</option>
                            <option></option>
                            <option selected="selected">3B</option>
                        </select>
